...
[[howto-use-tomcat-8]]
=== Use Tomcat 8.0
Tomcat 8.0 work with Spring Boot, but the default is to use Tomcat 8.5. If you cannot
...
[[howto-use-tomcat-8-maven]]
==== Use Tomcat 8.0 with Maven
...
==== Use Tomcat 8.0 with Gradle
[[howto-use-tomcat-8-gradle]]
...
Java 6-compatible container. Jetty 8 is Java 6 compatible. See
